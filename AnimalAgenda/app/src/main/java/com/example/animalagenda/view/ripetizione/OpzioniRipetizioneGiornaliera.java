...
import android.widget.GridView;   //Viene importata la classe estesa dalla vista personalizzata
...
/**
 * Questa classe permette di creare una GridView personalizzata per mostrare le opzioni di
 * ripetizione durante la creazione di un nuovo evento.
 */
public class OpzioniRipetizioneGiornaliera extends GridView {
     ...
     */
    public OpzioniRipetizioneGiornaliera(Context context) {
     ...
     */
    public OpzioniRipetizioneGiornaliera(Context context, AttributeSet attrs) {
     ...
     */
    public OpzioniRipetizioneGiornaliera(Context context, AttributeSet attrs, int defStyleAttr) {
